...
def process_depth_data(depth_array):
    ...
    for row in range(depth_array.shape[0]):
        for col in range(depth_array.shape[1]):
            ...
            if depth_array[row, col]!= 0 and depth_array[row, col] < 3000:
                h_val = row
        ...
        try:
            ...
            if os.path.exists(file_path):
                ...
                if depth_array.size != 0:
                    ...
                    far_h = 240*(1-math.sin(global_pitch))- far_h
                    ...
                    height_value= horizontal_distance= math.tan((3.14*0.121*(far_h)/180))*far_d
